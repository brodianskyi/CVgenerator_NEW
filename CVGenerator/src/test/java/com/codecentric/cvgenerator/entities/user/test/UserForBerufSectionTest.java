...
public class UserForBerufSectionTest extends CvGeneratorApplicationTests {
	...
	@Test
	public void findUserByBerufPositionTest() throws Exception {

		ResultActions resultActions = mockMvc.perform(get("/data/findUserByBerufPosition/beruf_position_test"))
	...
	@Test
	public void findUserByBerufStelleTest() throws Exception {

		ResultActions resultActions = mockMvc.perform(get("/data/findUserByBerufStelle/arbeitsstelle_test"))
				.andExpect(status().isOk())
				.andExpect(content().contentType(MediaType.parseMediaType("application/json;charset=UTF-8")));
