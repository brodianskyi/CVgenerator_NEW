...
public class UserForFachSectionTest extends CvGeneratorApplicationTests {
	...
	@Test
	public void findUserByFachGebietTest() throws Exception {

		ResultActions resultActions = mockMvc.perform(get("/data/findUserByFachGebiet/fach_gebiet_test"))
	...
	@Test
	public void findUserByFachKenntnisseTest() throws Exception {

		ResultActions resultActions = mockMvc.perform(get("/data/findUserByFachKenntnisse/fach_kenntnisse_test"))
				.andExpect(status().isOk())
				.andExpect(content().contentType(MediaType.parseMediaType("application/json;charset=UTF-8")));
